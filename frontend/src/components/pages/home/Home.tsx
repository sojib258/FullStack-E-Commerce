...
const Home = () => {
  return (
    <>
      ...
      {/* Featured Area */}
      <Box className={styles.featuredService}>
      ...
      {/* Product Area */}
      <Box className={styles.popularProducts}>
      ...
      <Box className={styles.discoverBanner}>
      ...
      <Box className={styles.featuredProduct}>
      ...
      {/* Latest News Area */}
      <Box className={styles.latestNews}>
